...
class BookAppointmentsScreen extends StatefulWidget {
  ...
  const BookAppointmentsScreen({Key? key, required this.doctorName, required this.doctorImage}) : super(key: key);
...
class _BookAppointmentsScreenState extends State<BookAppointmentsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: ExtraSmallText(text: 'Book Appointment', size: 20, color: Colors.white),
      ),
      body: Padding(
        padding: const EdgeInsets.fromLTRB(20, 25, 20, 20),
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: widget.doctorImage.isNotEmpty
                        ? NetworkImage(widget.doctorImage)
                        : const AssetImage('assets/neurologist.png') as ImageProvider,
                  ),
                  const SizedBox(width: 20),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ExtraSmallText(text: widget.doctorName, size: 20, color: Colors.black),
                      const SizedBox(height: 4),
                      const ExtraSmallText(text: 'Consultation Fee - 1000 Rs', size: 15, color: Colors.black),
                    ],
                  ),
                ],
              ),
            ...
            Row(
              children: [
                ElevatedButton(
                  ...
                  child: const ExtraSmallText(text: 'Select Date', color: Colors.white, size: 20),
                ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const ExtraSmallText(text: 'Next', size: 20, color: Colors.white),
              ),
            ),
          ],
        ),
